...
import { helpSchema, type HelpInput } from '../model/help';
...
export function HelpForm({ contactEmail, className }: HelpFormProps) {
  ...
  function onSubmit(values: HelpInput) {
  ...
  function fieldError(name: keyof HelpInput): string | undefined {
