    ...
    <ComboboxPrimitive.Portal>
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          className={cn(
            overlayPopupCls,
            "group/combobox-content relative w-(--anchor-width) min-w-[calc(var(--anchor-width)+--spacing(7))] data-[chips=true]:min-w-(--anchor-width)",
...
function ComboboxItem({
  ...
  return (
    ...
    >
      {children}
      <span aria-hidden className={cn(optionTrailingCheckSlotCls, "ml-auto")}>
