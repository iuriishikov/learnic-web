    ...
    <section className="relative isolate -mt-20 w-full overflow-hidden md:-mt-24">
      <div className="relative mx-auto w-full max-w-[1216px] px-4 md:px-6">
        <div className="relative pt-32 pb-12 md:pt-44 md:pb-16">
          <GridBackdrop className="-inset-x-8 -bottom-12 md:-inset-x-16 md:-bottom-16 lg:-inset-x-32 xl:-inset-x-48" />
        ...
        {hasResources && (
          ...
          >
            {resources.map(
              ({ icon: Icon, title: rTitle, description: rDescription, cta, href }, index) => (
                <motion.article
                  key={`${rTitle}-${index}`}
                  variants={fadeUp}
